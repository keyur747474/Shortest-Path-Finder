...
def run_GAmachine():
    ...
    file_path = 'c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/cities.txt'
    try:
    ...
    output_file = 'c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/output.txt'
    output_file2 = 'c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/output2.txt'
...
def index():
    try:
        with open('c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/output.txt','w') as fileo:
            fileo.write("")
    except FileNotFoundError:
...
def save_comment():
    if request.method == 'POST':
        ...
        if comment:
            with open('c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/cities.txt', 'w') as file: 
                file.write(route+'\n' +comment + '\n')  
...
def show_output():
    try:
        with open('c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/output.txt','r') as fileo:
            file_content = fileo.read()
    except FileNotFoundError:
        return "Error404: File not found"
    try:
        with open('c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/output2.txt','r') as fileo2:
...
def check_output():
    if os.path.exists('c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/output.txt') and os.path.getsize('c:/Users/Asus/Desktop/project_prototype_v3.0/project_prototype_v3.0/output.txt') > 0:
        return '1'
    else:
        return '0'
